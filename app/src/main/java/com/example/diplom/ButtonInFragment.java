...
public abstract class ButtonInFragment extends ItemTouchHelper.SimpleCallback {
    int buttonWidth;
    ...
    public ButtonInFragment(final Context context, RecyclerView recyclerView, int buttonWidth) {
    ...
    public float getSwipeThreashold(RecyclerView.ViewHolder viewHolder) { return swipeThreashold; }
