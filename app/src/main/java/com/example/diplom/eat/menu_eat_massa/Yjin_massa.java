...
public class Yjin_massa extends AppCompatActivity {
    ...
    private DatabaseReference first = databaseReference.child("36");
    private DatabaseReference two = databaseReference.child("37");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView = findViewById(R.id.semga);
        imageView2 = findViewById(R.id.ovsyanka);
    }
    @Override
