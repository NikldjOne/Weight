...
public class Perekys extends AppCompatActivity {
    ...
    private DatabaseReference first = databaseReference.child("13");
    private DatabaseReference two = databaseReference.child("8");
    private DatabaseReference three = databaseReference.child("14");
    @Override
