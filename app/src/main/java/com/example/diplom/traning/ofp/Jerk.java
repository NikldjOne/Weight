...
public class Jerk extends AppCompatActivity {
    private ImageView imageView, img_jerk_left, img_jerk_right, img_jerk_left2, img_jerk_left3,
            img_jerk_right2, img_jerk_right3;
    private LinearLayout layout, layout2, layout3, layout6;
    private TextView tv_weight, tv_result_jerk, tv_result_jerk2, tv_result_jerk3,tv_static_cl,tv_static_cl2,tv_static_cl3;
    private Button btn_jerk_back, btn_jerk_back2, btn_jerk_back3,
            btn_jerk_add, btn_jerk_add2, btn_jerk_add3,
            btn_jerk_done, btn_jerk_done2, btn_jerk_done3, close_ypr;
    ...
    private DatabaseReference weightList, resultsList, resultsList2, resultsList_week2,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resultsList_week2 = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week2").child("Jerk");
        resultsList_week3 = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week3").child("Jerk");
        resultsList_week4 = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week4").child("Jerk");
        resultsList_week5 = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week5").child("Jerk");
        resultsList_week6 = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week6").child("Jerk");
        resultsList_week7 = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week7").child("Jerk");
        resultsList_week8 = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week8").child("Jerk");
        resultPodhod();
        jerkPodhod();
        jerkPodhod2();
        jerkPodhod3();
        tv_static_cl = findViewById(R.id.tv_static_cl);
        tv_static_cl2 = findViewById(R.id.tv_static_cl2);
        tv_static_cl3 = findViewById(R.id.tv_static_cl3);
                                                    ...
                                                    resultsList.child("jerk_done").addValueEventListener(new ValueEventListener() {
                                                        ...
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                done_week1.child("day1_done").setValue("1");
                                                                finish();
                                                            }
                                    ...
                                    case 2:
                                        done_week2.child("Week2_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList_week2.child("jerk_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if (weight == null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week2.child("jerk_done").setValue("1");
                                                                done_week2.child("day1_done").setValue("1");
                                                                finish();
                                                            }
                                    ...
                                    case 3:
                                        done_week3.child("Week3_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList_week3.child("jerk_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if (weight == null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week3.child("jerk_done").setValue("1");
                                                                done_week3.child("day1_done").setValue("1");
                                                                finish();
                                                            }
                                    ...
                                    case 4:
                                        done_week4.child("Week4_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList_week4.child("jerk_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if (weight == null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week4.child("jerk_done").setValue("1");
                                                                done_week4.child("day1_done").setValue("1");
                                                                finish();
                                                            }
                                    ...
                                    case 5:
                                        done_week5.child("Week5_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList_week5.child("jerk_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if (weight == null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week5.child("jerk_done").setValue("1");
                                                                done_week5.child("day1_done").setValue("1");
                                                                finish();
                                                            }
                                    ...
                                    case 6:
                                        done_week6.child("Week6_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList_week6.child("jerk_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if (weight == null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week6.child("jerk_done").setValue("1");
                                                                done_week6.child("day1_done").setValue("1");
                                                                finish();
                                                            }
                                    ...
                                    case 7:
                                        done_week7.child("Week7_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList_week7.child("jerk_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if (weight == null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week7.child("jerk_done").setValue("1");
                                                                done_week7.child("day1_done").setValue("1");
                                                                finish();
                                                            }
                                    ...
                                    case 8:
                                        done_week8.child("Week8_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList_week8.child("jerk_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if (weight == null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week8.child("jerk_done").setValue("1");
                                                                done_week8.child("day1_done").setValue("1");
                                                                finish();
                                                            }
                                    ...
                                    if (weight != null) {
                                        ...
                                        resultsList.child("jerk_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    btn_jerk_back.setVisibility(View.INVISIBLE);
                                                    btn_jerk_add.setVisibility(View.INVISIBLE);
                                                    img_jerk_right.setVisibility(View.INVISIBLE);
                                                    img_jerk_left.setVisibility(View.INVISIBLE);
                                                    edit_result.setVisibility(View.INVISIBLE);
                                                    tv_result_jerk.setVisibility(View.VISIBLE);

                                                    btn_jerk_back2.setVisibility(View.INVISIBLE);
                                                    btn_jerk_add2.setVisibility(View.INVISIBLE);
                                                    img_jerk_right2.setVisibility(View.INVISIBLE);
                                                    img_jerk_left2.setVisibility(View.INVISIBLE);
                                                    edit_result2.setVisibility(View.INVISIBLE);
                                                    tv_result_jerk2.setVisibility(View.VISIBLE);

                                                    btn_jerk_back3.setVisibility(View.INVISIBLE);
                                                    btn_jerk_add3.setVisibility(View.INVISIBLE);
                                                    img_jerk_right3.setVisibility(View.INVISIBLE);
                                                    img_jerk_left3.setVisibility(View.INVISIBLE);
                                                    edit_result3.setVisibility(View.INVISIBLE);
                                                    tv_result_jerk3.setVisibility(View.VISIBLE);
                                    ...
                                    if (weight != null) {
                                        ...
                                        resultsList.child("jerk_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                ...
                                                if (g != null) {
                                                    tv_static_cl.setText(ed_result6);
                                                    tv_static_cl2.setText(ed_result7);
                                                    tv_static_cl3.setText(ed_result8);
    ...
    private void jerkPodhod3() {
        tv_result_jerk3 = findViewById(R.id.tv_result_jerk3);
        edit_result3 = findViewById(R.id.ed_result_jerk3);
        btn_jerk_add3 = findViewById(R.id.btn_jerk_add3);
        btn_jerk_back3 = findViewById(R.id.btn_jerk_back3);
        btn_jerk_done3 = findViewById(R.id.btn_jerk_done3);
        layout3 = findViewById(R.id.layout_done_jerk3);
        img_jerk_left3 = findViewById(R.id.img_jerk_left3);
        img_jerk_right3 = findViewById(R.id.img_jerk_right3);


        btn_jerk_add3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                edAdd3();
            }
        });
        btn_jerk_back3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                edBack3();
            }
        });
        btn_jerk_done3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                podhodDone3();
            }
    ...
    private void jerkPodhod2() {
        tv_result_jerk2 = findViewById(R.id.tv_result_jerk2);
        edit_result2 = findViewById(R.id.ed_result_jerk2);
        btn_jerk_add2 = findViewById(R.id.btn_jerk_add2);
        btn_jerk_back2 = findViewById(R.id.btn_jerk_back2);
        btn_jerk_done2 = findViewById(R.id.btn_jerk_done2);
        layout2 = findViewById(R.id.layout_done_jerk2);
        img_jerk_left2 = findViewById(R.id.img_jerk_left2);
        img_jerk_right2 = findViewById(R.id.img_jerk_right2);


        btn_jerk_add2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                edAdd2();
            }
        });
        btn_jerk_back2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                edBack2();
            }
        });
        btn_jerk_done2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                podhodDone2();
            }
    ...
    private void jerkPodhod() {
        tv_result_jerk = findViewById(R.id.tv_result_jerk);
        edit_result = findViewById(R.id.ed_result_jerk);
        btn_jerk_add = findViewById(R.id.btn_jerk_add);
        btn_jerk_back = findViewById(R.id.btn_jerk_back);
        btn_jerk_done = findViewById(R.id.btn_jerk_done);
        layout = findViewById(R.id.layout_done_jerk);
        img_jerk_left = findViewById(R.id.img_jerk_left);
        img_jerk_right = findViewById(R.id.img_jerk_right);

        btn_jerk_add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                edAdd();
            }
        });
        btn_jerk_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                edBack();
            }
        });
        btn_jerk_done.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                podhodDone();
            }
    ...
    private void podhodDone3() {
        if (podhod3 == false) {
            ...
            podhod3 = false;
            img_jerk_right3.setVisibility(View.VISIBLE);
            img_jerk_left3.setVisibility(View.VISIBLE);
            btn_jerk_back3.setVisibility(View.VISIBLE);
            btn_jerk_add3.setVisibility(View.VISIBLE);
            edit_result3.setVisibility(View.VISIBLE);
            tv_result_jerk3.setVisibility(View.INVISIBLE);
    ...
    private void podhodDone2() {
        if (podhod2 == false) {
            ...
            podhod2 = false;
            img_jerk_right2.setVisibility(View.VISIBLE);
            img_jerk_left2.setVisibility(View.VISIBLE);
            btn_jerk_back2.setVisibility(View.VISIBLE);
            btn_jerk_add2.setVisibility(View.VISIBLE);
            edit_result2.setVisibility(View.VISIBLE);
            tv_result_jerk2.setVisibility(View.INVISIBLE);
    ...
    private void podhodDone() {
        if (podhod == false) {
            ...
            podhod = false;
            img_jerk_right.setVisibility(View.VISIBLE);
            img_jerk_left.setVisibility(View.VISIBLE);
            btn_jerk_back.setVisibility(View.VISIBLE);
            btn_jerk_add.setVisibility(View.VISIBLE);
            edit_result.setVisibility(View.VISIBLE);
            tv_result_jerk.setVisibility(View.INVISIBLE);
