...
public class Deadlift_Clean extends AppCompatActivity {
    ...
    private TextView tv_weight, tv_result_squat, tv_result_squat2, tv_result_squat3, tv_result_squat4, tv_result_squat5,
            tv_static_deadcl, tv_static_deadcl2, tv_static_deadcl3, tv_static_deadcl4, tv_static_deadcl5;
    ...
    private DatabaseReference first = databaseReference.child("49");
    ...
    String stringdouble = "40.0";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_deadlift__clean);
        getSupportActionBar().setDisplayOptions(ActionBar.DISPLAY_SHOW_CUSTOM);
        getSupportActionBar().setCustomView(R.layout.action_bar_layout_14);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        imageView = findViewById(R.id.img_deadcl2);
        tv_weight = findViewById(R.id.tv_weight_deadcl);
        weightList = firebaseDatabase2.getReference("Records").child(user.getUid());
        resultsList = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week1").child("Deadlift_Clean");
        ...
        resultsList_week2 = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week2").child("Deadlift_Clean");
        resultsList_week3 = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week3").child("Deadlift_Clean");
        resultsList_week4 = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week4").child("Deadlift_Clean");
        resultsList_week5 = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week5").child("Deadlift_Clean");
        resultsList_week6 = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week6").child("Deadlift_Clean");
        resultsList_week7 = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week7").child("Deadlift_Clean");
        resultsList_week8 = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week8").child("Deadlift_Clean");
        close_ypr = findViewById(R.id.close_ypr_deadcl);
        tv_static_deadcl = findViewById(R.id.tv_static_deadcl);
        tv_static_deadcl2 = findViewById(R.id.tv_static_deadcl2);
        tv_static_deadcl3 = findViewById(R.id.tv_static_deadcl3);
        tv_static_deadcl4 = findViewById(R.id.tv_static_deadcl4);
        close_ypr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (podhod == true && podhod2 == true && podhod3 == true && podhod4 == true) {
                                    ...
                                    case 1:
                                        done_week1.child("Week1_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList.child("deadcl_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if (weight == null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList.child("deadcl_done").setValue("1");
                                                                finish();
                                                            }
                                    ...
                                    case 2:
                                        done_week2.child("Week2_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList_week2.child("deadcl_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if (weight == null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week2.child("deadcl_done").setValue("1");
                                                                finish();
                                                            }
                                    ...
                                    case 3:
                                        done_week3.child("Week3_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList_week3.child("deadcl_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if (weight == null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week3.child("deadcl_done").setValue("1");
                                                                finish();
                                                            }
                                    ...
                                    case 4:
                                        done_week4.child("Week4_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList_week4.child("deadcl_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if (weight == null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week4.child("deadcl_done").setValue("1");
                                                                finish();
                                                            }
                                    ...
                                    case 5:
                                        done_week5.child("Week5_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList_week5.child("deadcl_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if (weight == null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week5.child("deadcl_done").setValue("1");
                                                                finish();
                                                            }
                                    ...
                                    case 6:
                                        done_week6.child("Week6_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList_week6.child("deadcl_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if (weight == null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week6.child("deadcl_done").setValue("1");
                                                                finish();
                                                            }
                                    ...
                                    case 7:
                                        done_week7.child("Week7_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList_week7.child("deadcl_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if (weight == null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week7.child("deadcl_done").setValue("1");
                                                                finish();
                                                            }
                                    ...
                                    case 8:
                                        done_week8.child("Week8_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList_week8.child("deadcl_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if (weight == null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week8.child("deadcl_done").setValue("1");
                                                                finish();
                                                            }
                    ...
                    Toast.makeText(Deadlift_Clean.this, "Вы не закончили все подходы", Toast.LENGTH_SHORT).show();
            }
        });
        resultPodhod();
        SquatPodhod();
                                        ...
                                        resultsList.child("deadcl_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                ...
                                                if (weight != null) {
                                                    ...
                                                    layout6 = findViewById(R.id.layout_done_deadcl6);
                                    ...
                                    if (weight != null) {
                                        ...
                                        resultsList.child("deadcl_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                ...
                                                if(g!=null) {
                                                    tv_static_deadcl.setText(weight_st + " на " + ed_result6);
                                                    tv_static_deadcl2.setText(weight_st + " на " + ed_result7);
                                                    tv_static_deadcl3.setText(weight_st + " на " + ed_result8);
                                                    tv_static_deadcl4.setText(weight_st + " на " + ed_result9);
                                                }
                                            }
                                            @Override
                                            public void onCancelled(@NonNull DatabaseError databaseError) {
    ...
    private void SquatPodhod4() {
        tv_result_squat4 = findViewById(R.id.tv_result_deadcl4);
        edit_result4 = findViewById(R.id.ed_result_deadcl4);
        btn_squat_add4 = findViewById(R.id.btn_deadcl_add4);
        btn_squat_back4 = findViewById(R.id.btn_deadcl_back4);
        btn_squat_done4 = findViewById(R.id.btn_deadcl_done4);
        layout4 = findViewById(R.id.layout_done_deadcl4);
        img_squat_left4 = findViewById(R.id.img_deadcl_left4);
        img_squat_right4 = findViewById(R.id.img_deadcl_right4);
    ...
    private void SquatPodhod3() {
        tv_result_squat3 = findViewById(R.id.tv_result_deadcl3);
        edit_result3 = findViewById(R.id.ed_result_deadcl3);
        btn_squat_add3 = findViewById(R.id.btn_deadcl_add3);
        btn_squat_back3 = findViewById(R.id.btn_deadcl_back3);
        btn_squat_done3 = findViewById(R.id.btn_deadcl_done3);
        layout3 = findViewById(R.id.layout_done_deadcl3);
        img_squat_left3 = findViewById(R.id.img_deadcl_left3);
        img_squat_right3 = findViewById(R.id.img_deadcl_right3);
    ...
    private void SquatPodhod2() {
        tv_result_squat2 = findViewById(R.id.tv_result_deadcl2);
        edit_result2 = findViewById(R.id.ed_result_deadcl2);
        btn_squat_add2 = findViewById(R.id.btn_deadcl_add2);
        btn_squat_back2 = findViewById(R.id.btn_deadcl_back2);
        btn_squat_done2 = findViewById(R.id.btn_deadcl_done2);
        layout2 = findViewById(R.id.layout_done_deadcl2);
        img_squat_left2 = findViewById(R.id.img_deadcl_left2);
        img_squat_right2 = findViewById(R.id.img_deadcl_right2);
    ...
    private void SquatPodhod() {
        tv_result_squat = findViewById(R.id.tv_result_deadcl);
        edit_result = findViewById(R.id.ed_result_deadcl);
        btn_squat_add = findViewById(R.id.btn_deadcl_add);
        btn_squat_back = findViewById(R.id.btn_deadcl_back);
        btn_squat_done = findViewById(R.id.btn_deadcl_done);
        layout = findViewById(R.id.layout_done_deadcl);
        img_squat_left = findViewById(R.id.img_deadcl_left);
        img_squat_right = findViewById(R.id.img_deadcl_right);
