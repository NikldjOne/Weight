...
public class Planka extends AppCompatActivity {
    ...
    private TextView tv_weight, tv_result_squat, tv_result_squat2, tv_result_squat3,tv_static_planka,tv_static_planka2,tv_static_planka3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_static_planka = findViewById(R.id.tv_static_planka);
        tv_static_planka2 = findViewById(R.id.tv_static_planka2);
        tv_static_planka3 = findViewById(R.id.tv_static_planka3);
                                    ...
                                    if (weight != null) {
                                        ...
                                        resultsList.child("planka_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                ...
                                                if (g != null) {
                                                    tv_static_planka.setText(ed_result6);
                                                    tv_static_planka2.setText(ed_result7);
                                                    tv_static_planka3.setText(ed_result8);
