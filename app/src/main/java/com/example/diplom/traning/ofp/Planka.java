...
public class Planka extends AppCompatActivity {
    ...
    private DatabaseReference weightList, resultsList, kolvoList,day7_done;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kolvoList = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week1").child("Planka");
        day7_done = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week1");
        ...
        close_ypr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (podhod == true && podhod2 == true && podhod3 == true) {
                    ...
                    day7_done.child("day7_done").setValue("1");
                    finish();
                } else
