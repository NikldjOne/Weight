                                                    ...
                                                    resultsList_week2.child("squat_done").addValueEventListener(new ValueEventListener() {
                                                        ...
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week2.child("kol-vo5").setValue(ed_result5);
                                                                resultsList_week2.child("squat_done").setValue("1");
                                                                finish();
                                                            }
                                                    ...
                                                    resultsList_week3.child("squat_done").addValueEventListener(new ValueEventListener() {
                                                        ...
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week3.child("kol-vo5").setValue(ed_result5);
                                                                resultsList_week3.child("squat_done").setValue("1");
                                                                finish();
                                                            }
                                                    ...
                                                    resultsList_week4.child("squat_done").addValueEventListener(new ValueEventListener() {
                                                        ...
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week4.child("kol-vo5").setValue(ed_result5);
                                                                resultsList_week4.child("squat_done").setValue("1");
                                                                finish();
                                                            }
                                                    ...
                                                    resultsList_week5.child("squat_done").addValueEventListener(new ValueEventListener() {
                                                        ...
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week5.child("kol-vo5").setValue(ed_result5);
                                                                resultsList_week5.child("squat_done").setValue("1");
                                                                finish();
                                                            }
                                                    ...
                                                    resultsList_week6.child("squat_done").addValueEventListener(new ValueEventListener() {
                                                        ...
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week6.child("kol-vo5").setValue(ed_result5);
                                                                resultsList_week6.child("squat_done").setValue("1");
                                                                finish();
                                                            }
                                                    ...
                                                    resultsList_week7.child("squat_done").addValueEventListener(new ValueEventListener() {
                                                        ...
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week7.child("kol-vo5").setValue(ed_result5);
                                                                resultsList_week7.child("squat_done").setValue("1");
                                                                finish();
                                                            }
                                                    ...
                                                    resultsList_week8.child("squat_done").addValueEventListener(new ValueEventListener() {
                                                        ...
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week8.child("kol-vo5").setValue(ed_result5);
                                                                resultsList_week8.child("squat_done").setValue("1");
                                                                finish();
                                                            }
                            ...
                            done_week8.child("Week8_done").addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    ...
                                    if (weight != null) {
                                        ...
                                        resultsList_week8.child("kol-vo5").addValueEventListener(new ValueEventListener() {
                                            @Override
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String povtor = dataSnapshot.getValue(String.class);
                                                if (povtor != null) {
