...
public class Bench extends AppCompatActivity {
    ...
    private TextView tv_weight, tv_result_Bench, tv_result_Bench2, tv_result_Bench3,tv_static_bench,tv_static_bench2,tv_static_bench3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setCustomView(R.layout.action_bar_layout_16);
        ...
        tv_static_bench = findViewById(R.id.tv_static_bench);
        tv_static_bench2 = findViewById(R.id.tv_static_bench2);
        tv_static_bench3 = findViewById(R.id.tv_static_bench3);
                                    ...
                                    if (weight != null) {
                                        ...
                                        resultsList.child("bench_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                ...
                                                if (g != null) {
                                                    tv_static_bench.setText(weight_st + " на " + ed_result6);
                                                    tv_static_bench2.setText(weight_st + " на " + ed_result7);
                                                    tv_static_bench3.setText(weight_st + " на " + ed_result8);
