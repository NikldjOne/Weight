...
public class FrontSquat extends AppCompatActivity {
    private ImageView imageView, img_squat_left, img_squat_right, img_squat_left2, img_squat_left3, img_squat_left4,
            img_squat_left5, img_squat_right2, img_squat_right3, img_squat_right4, img_front_done;
    private LinearLayout layout, layout2, layout3, layout4, layout6;
    private TextView tv_weight, tv_result_squat, tv_result_squat2, tv_result_squat3, tv_result_squat4,
            tv_static_frsquat, tv_static_frsquat2, tv_static_frsquat3, tv_static_frsquat4, tv_static_frsquat5;
    private Button btn_squat_back, btn_squat_back2, btn_squat_back3, btn_squat_back4,
            btn_squat_add, btn_squat_add2, btn_squat_add3, btn_squat_add4, close_ypr,
            btn_front_done, btn_front_done2, btn_front_done3, btn_front_done4;
    ...
    private Integer result = 0, result2 = 0, result3 = 0, result4 = 0;
    private String ed_result, ed_result2, ed_result3, ed_result4, ed_result6, ed_result7, ed_result8, ed_result9 ,weight_st,
            weight_work;
    private EditText edit_result, edit_result2, edit_result3, edit_result4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_front_squat);
        getSupportActionBar().setDisplayOptions(ActionBar.DISPLAY_SHOW_CUSTOM);
        getSupportActionBar().setCustomView(R.layout.action_bar_layout_7);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        imageView = findViewById(R.id.img_front_squat2);
        tv_weight = findViewById(R.id.tv_weight_front);
        ...
        close_ypr = findViewById(R.id.close_ypr_front);
        tv_static_frsquat = findViewById(R.id.tv_static_frsquat);
        tv_static_frsquat2 = findViewById(R.id.tv_static_frsquat2);
        tv_static_frsquat3 = findViewById(R.id.tv_static_frsquat3);
        tv_static_frsquat4 = findViewById(R.id.tv_static_frsquat4);
        close_ypr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (podhod == true && podhod2 == true && podhod3 == true && podhod4 == true) {
                                                    ...
                                                    resultsList.child("front_done").addValueEventListener(new ValueEventListener() {
                                                        ...
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList.child("front_done").setValue("1");
                                                                finish();
                                                            }
                                                    ...
                                                    resultsList_week2.child("front_done").addValueEventListener(new ValueEventListener() {
                                                        ...
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week2.child("front_done").setValue("1");
                                                                finish();
                                                            }
                                                    ...
                                                    resultsList_week3.child("front_done").addValueEventListener(new ValueEventListener() {
                                                        ...
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week3.child("front_done").setValue("1");
                                                                finish();
                                                            }
                                                    ...
                                                    resultsList_week4.child("front_done").addValueEventListener(new ValueEventListener() {
                                                        ...
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week4.child("front_done").setValue("1");
                                                                finish();
                                                            }
                                                    ...
                                                    resultsList_week5.child("front_done").addValueEventListener(new ValueEventListener() {
                                                        ...
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week5.child("front_done").setValue("1");
                                                                finish();
                                                            }
                                                    ...
                                                    resultsList_week6.child("front_done").addValueEventListener(new ValueEventListener() {
                                                        ...
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week6.child("front_done").setValue("1");
                                                                finish();
                                                            }
                                                    ...
                                                    resultsList_week7.child("front_done").addValueEventListener(new ValueEventListener() {
                                                        ...
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week7.child("front_done").setValue("1");
                                                                finish();
                                                            }
                                                    ...
                                                    resultsList_week8.child("front_done").addValueEventListener(new ValueEventListener() {
                                                        ...
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week8.child("front_done").setValue("1");
                                                                finish();
                                                            }
                    ...
                    Toast.makeText(FrontSquat.this, "Вы не закончили все подходы", Toast.LENGTH_SHORT).show();
            }
        });
        resultPodhod();
        SquatPodhod();
                                        ...
                                        resultsList.child("front_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                ...
                                                if (weight != null) {
                                                    ...
                                                    layout6 = findViewById(R.id.layout_done_front6);
                            ...
                            done_week1.child("Week1_done").addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    ...
                                    if (weight != null) {
                                        ...
                                        resultsList.addValueEventListener(new ValueEventListener() {
                                            @Override
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                tv_static_frsquat.setText(weight_st + " на " + ed_result6);
                                                tv_static_frsquat2.setText(weight_st + " на " + ed_result7);
                                                tv_static_frsquat3.setText(weight_st + " на " + ed_result8);
                                                tv_static_frsquat4.setText(weight_st + " на " + ed_result9);
                                            }
                                            @Override
                                            public void onCancelled(@NonNull DatabaseError databaseError) {
                                            }
                            ...
                            done_week2.child("Week2_done").addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    ...
                                    if (weight != null) {
                                        ...
                                        resultsList_week2.addValueEventListener(new ValueEventListener() {
                                            @Override
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                tv_static_frsquat.setText(weight_st + " на " + ed_result6);
                                                tv_static_frsquat2.setText(weight_st + " на " + ed_result7);
                            ...
                            done_week3.child("Week3_done").addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    ...
                                    if (weight != null) {
                                        ...
                                        resultsList_week3.addValueEventListener(new ValueEventListener() {
                                            @Override
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                tv_static_frsquat.setText(weight_st + " на " + ed_result6);
                                                tv_static_frsquat2.setText(weight_st + " на " + ed_result7);
                            ...
                            done_week4.child("Week4_done").addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    ...
                                    if (weight != null) {
                                        ...
                                        resultsList_week4.addValueEventListener(new ValueEventListener() {
                                            @Override
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                tv_static_frsquat.setText(weight_st + " на " + ed_result6);
                                                tv_static_frsquat2.setText(weight_st + " на " + ed_result7);
                            ...
                            done_week5.child("Week5_done").addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    ...
                                    if (weight != null) {
                                        ...
                                        resultsList_week5.addValueEventListener(new ValueEventListener() {
                                            @Override
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                tv_static_frsquat.setText(weight_st + " на " + ed_result6);
                                                tv_static_frsquat2.setText(weight_st + " на " + ed_result7);
                            ...
                            done_week6.child("Week6_done").addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    ...
                                    if (weight != null) {
                                        ...
                                        resultsList_week6.addValueEventListener(new ValueEventListener() {
                                            @Override
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                tv_static_frsquat.setText(weight_st + " на " + ed_result6);
                                                tv_static_frsquat2.setText(weight_st + " на " + ed_result7);
                            ...
                            done_week7.child("Week7_done").addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    ...
                                    if (weight != null) {
                                        ...
                                        resultsList_week7.addValueEventListener(new ValueEventListener() {
                                            @Override
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                tv_static_frsquat.setText(weight_st + " на " + ed_result6);
                                                tv_static_frsquat2.setText(weight_st + " на " + ed_result7);
    ...
    private void SquatPodhod4() {
        tv_result_squat4 = findViewById(R.id.tv_result_front4);
        edit_result4 = findViewById(R.id.ed_result_front4);
        btn_squat_add4 = findViewById(R.id.btn_front_add4);
        btn_squat_back4 = findViewById(R.id.btn_front_back4);
        btn_front_done4 = findViewById(R.id.btn_front_done4);
        layout4 = findViewById(R.id.layout_done_front4);
        img_squat_left4 = findViewById(R.id.img_front_left4);
        img_squat_right4 = findViewById(R.id.img_front_right4);
        ...
        btn_front_done4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                podhodDone4();
            }
    ...
    private void SquatPodhod3() {
        tv_result_squat3 = findViewById(R.id.tv_result_front3);
        edit_result3 = findViewById(R.id.ed_result_front3);
        btn_squat_add3 = findViewById(R.id.btn_front_add3);
        btn_squat_back3 = findViewById(R.id.btn_front_back3);
        btn_front_done3 = findViewById(R.id.btn_front_done3);
        layout3 = findViewById(R.id.layout_done_front3);
        img_squat_left3 = findViewById(R.id.img_front_left3);
        img_squat_right3 = findViewById(R.id.img_front_right3);
        ...
        btn_front_done3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                podhodDone3();
            }
    ...
    private void SquatPodhod2() {
        tv_result_squat2 = findViewById(R.id.tv_result_front2);
        edit_result2 = findViewById(R.id.ed_result_front2);
        btn_squat_add2 = findViewById(R.id.btn_front_add2);
        btn_squat_back2 = findViewById(R.id.btn_front_back2);
        btn_front_done2 = findViewById(R.id.btn_front_done2);
        layout2 = findViewById(R.id.layout_done_front2);
        img_squat_left2 = findViewById(R.id.img_front_left2);
        img_squat_right2 = findViewById(R.id.img_front_right2);
        ...
        btn_front_done2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                podhodDone2();
            }
    ...
    private void SquatPodhod() {
        tv_result_squat = findViewById(R.id.tv_result_front);
        edit_result = findViewById(R.id.ed_result_front);
        btn_squat_add = findViewById(R.id.btn_front_add);
        btn_squat_back = findViewById(R.id.btn_front_back);
        btn_front_done = findViewById(R.id.btn_front_done);
        layout = findViewById(R.id.layout_done_front);
        img_squat_left = findViewById(R.id.img_front_left);
        img_squat_right = findViewById(R.id.img_front_right);
        ...
        btn_front_done.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                podhodDone();
            }
    ...
    protected void onStart() {
        ...
        weightList.child("max_front").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                String weight = dataSnapshot.getValue(String.class);
