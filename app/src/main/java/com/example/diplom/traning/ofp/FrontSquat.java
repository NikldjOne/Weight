...
public class FrontSquat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kolvoList = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week1").child("Front_Squat");
    ...
    private void SquatPodhod4() {
        ...
        btn_squat_done4 = findViewById(R.id.btn_front_done4);
    ...
    private void SquatPodhod3() {
        ...
        btn_squat_done3 = findViewById(R.id.btn_front_done3);
    ...
    private void SquatPodhod2() {
        ...
        btn_squat_done2 = findViewById(R.id.btn_front_done2);
    ...
    private void SquatPodhod() {
        ...
        btn_squat_done = findViewById(R.id.btn_front_done);
