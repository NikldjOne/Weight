...
public class Shil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView = findViewById(R.id.img_shil_window);
        closeypr_shil = findViewById(R.id.close_ypr_shil);
        tv_result = findViewById(R.id.tv_ypr_shil);
        layout = findViewById(R.id.layout_done_shil6);
                ...
                week_done.child("Week_done").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if (weight != null) {
                            ...
                            switch (pos) {
                                case 1:
                                    resultsList_week1.child("day2_done").setValue("1");
                                    finish();
                                    break;
                                case 2:
                                    resultsList_week2.child("day2_done").setValue("1");
                                    finish();
                                    break;
                                case 3:
                                    resultsList_week3.child("day2_done").setValue("1");
                                    finish();
                                    break;
                                case 4:
                                    resultsList_week4.child("day2_done").setValue("1");
                                    finish();
                                    break;
                                case 5:
                                    resultsList_week5.child("day2_done").setValue("1");
                                    finish();
                                    break;
                                case 6:
                                    resultsList_week6.child("day2_done").setValue("1");
                                    finish();
                                    break;
                                case 7:
                                    resultsList_week7.child("day2_done").setValue("1");
                                    finish();
                                    break;
                                case 8:
                                    resultsList_week8.child("day2_done").setValue("1");
                                    finish();
                                    break;
                            }
                        }
                ...
                if (weight != null){
                    ...
                    switch (pos){
                        case 1: resultsList_week1.child("day2_done").addValueEventListener(new ValueEventListener() {
                            ...
                            break;
                        case 2: resultsList_week2.child("day2_done").addValueEventListener(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                String weight = dataSnapshot.getValue(String.class);
                                if (weight != null) {
                            ...
                            break;
                        case 3: resultsList_week3.child("day2_done").addValueEventListener(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                String weight = dataSnapshot.getValue(String.class);
                                if (weight != null) {
                            ...
                            break;
                        case 4: resultsList_week4.child("day2_done").addValueEventListener(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                String weight = dataSnapshot.getValue(String.class);
                                if (weight != null) {
                            ...
                            break;
                        case 5: resultsList_week5.child("day2_done").addValueEventListener(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                String weight = dataSnapshot.getValue(String.class);
                                if (weight != null) {
                            ...
                            break;
                        case 6: resultsList_week6.child("day2_done").addValueEventListener(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                String weight = dataSnapshot.getValue(String.class);
                                if (weight != null) {
                            ...
                            break;
                        case 7: resultsList_week7.child("day2_done").addValueEventListener(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                String weight = dataSnapshot.getValue(String.class);
                                if (weight != null) {
                            ...
                            break;
                        case 8: resultsList_week8.child("day2_done").addValueEventListener(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                String weight = dataSnapshot.getValue(String.class);
                                if (weight != null) {
