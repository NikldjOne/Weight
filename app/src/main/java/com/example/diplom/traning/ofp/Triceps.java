...
public class Triceps extends AppCompatActivity {
    ...
    private DatabaseReference weightList, resultsList, kolvoList,day4_done;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kolvoList = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week1").child("Triceps");
        day4_done = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week1");
        ...
        close_ypr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (podhod == true && podhod2 == true && podhod3 == true) {
                    ...
                    day4_done.child("day5_done").setValue("1");
                    finish();
                } else
