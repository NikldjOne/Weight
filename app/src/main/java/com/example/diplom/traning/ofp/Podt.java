...
public class Podt extends AppCompatActivity {
    ...
    private TextView tv_weight, tv_result_squat, tv_result_squat2, tv_result_squat3, tv_result_squat4, tv_result_squat5,
            tv_static_podt, tv_static_podt2, tv_static_podt3, tv_static_podt4, tv_static_podt5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setCustomView(R.layout.action_bar_layout_15);
        ...
        tv_static_podt = findViewById(R.id.tv_static_podt);
        tv_static_podt2 = findViewById(R.id.tv_static_podt2);
        tv_static_podt3 = findViewById(R.id.tv_static_podt3);
        tv_static_podt4 = findViewById(R.id.tv_static_podt4);
                                    ...
                                    if (weight != null) {
                                        ...
                                        resultsList.child("podt_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                ...
                                                if(g!=null) {
                                                    tv_static_podt.setText(ed_result6);
                                                    tv_static_podt2.setText(ed_result7);
                                                    tv_static_podt3.setText(ed_result8);
                                                    tv_static_podt4.setText(ed_result9);
                                                }
                                            }
                                            @Override
                                            public void onCancelled(@NonNull DatabaseError databaseError) {
