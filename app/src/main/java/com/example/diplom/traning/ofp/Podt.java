...
public class Podt extends AppCompatActivity {
    ...
    private DatabaseReference weightList, resultsList, kolvoList,day3_done;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kolvoList = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week1").child("Podt");
        day3_done = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week1");
        ...
        close_ypr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (podhod == true && podhod2 == true && podhod3 == true && podhod4 == true) {
                    ...
                    day3_done.child("day3_done").setValue("1");
                    finish();
                } else
