...
public class Press extends AppCompatActivity {
    ...
    private TextView tv_weight, tv_result_squat, tv_result_squat2, tv_result_squat3,tv_static_press,tv_static_press2,tv_static_press3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resultsList_week2 = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week2").child("Press");
        resultsList_week3 = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week3").child("Press");
        resultsList_week4 = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week4").child("Press");
        resultsList_week5 = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week5").child("Press");
        resultsList_week6 = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week6").child("Press");
        resultsList_week7 = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week7").child("Press");
        resultsList_week8 = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week8").child("Press");
        close_ypr = findViewById(R.id.close_ypr_press);
        tv_static_press = findViewById(R.id.tv_static_press);
        tv_static_press2 = findViewById(R.id.tv_static_press2);
        tv_static_press3 = findViewById(R.id.tv_static_press3);
        close_ypr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (podhod == true && podhod2 == true && podhod3 == true) {
                                                    ...
                                                    resultsList.child("press_done").addValueEventListener(new ValueEventListener() {
                                                        ...
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList.child("press_done").setValue("1");
                                                                finish();
                                                            }
                                    ...
                                    case 2:
                                        done_week2.child("Week2_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList_week2.child("press_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if(weight==null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week2.child("press_done").setValue("1");
                                                                finish();
                                                            }
                                    ...
                                    case 3:
                                        done_week3.child("Week3_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList_week3.child("press_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if(weight==null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week3.child("press_done").setValue("1");
                                                                finish();
                                                            }
                                    ...
                                    case 4:
                                        done_week4.child("Week4_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList_week4.child("press_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if(weight==null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week4.child("press_done").setValue("1");
                                                                finish();
                                                            }
                                    ...
                                    case 5:
                                        done_week5.child("Week5_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList_week5.child("press_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if(weight==null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week5.child("press_done").setValue("1");
                                                                finish();
                                                            }
                                    ...
                                    case 6:
                                        done_week6.child("Week6_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList_week6.child("press_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if(weight==null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week6.child("press_done").setValue("1");
                                                                finish();
                                                            }
                                    ...
                                    case 7:
                                        done_week7.child("Week7_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList_week7.child("press_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if(weight==null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week7.child("press_done").setValue("1");
                                                                finish();
                                                            }
                                    ...
                                    case 8:
                                        done_week8.child("Week8_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList_week8.child("press_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if(weight==null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week8.child("press_done").setValue("1");
                                                                finish();
                                                            }
                    ...
                    Toast.makeText(Press.this, "Вы не закончили все подходы", Toast.LENGTH_SHORT).show();
            }
        });
        resultPodhod();
        SquatPodhod();
                                    ...
                                    if (weight != null) {
                                        ...
                                        resultsList.child("press_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                ...
                                                if (g != null) {
                                                    tv_static_press.setText(ed_result6);
                                                    tv_static_press2.setText(ed_result7);
                                                    tv_static_press3.setText(ed_result8);
    ...
    private void SquatPodhod3() {
        tv_result_squat3 = findViewById(R.id.tv_result_press3);
        edit_result3 = findViewById(R.id.ed_result_press3);
        btn_squat_add3 = findViewById(R.id.btn_press_add3);
        btn_squat_back3 = findViewById(R.id.btn_press_back3);
        btn_squat_done3 = findViewById(R.id.btn_press_done3);
        layout3 = findViewById(R.id.layout_done_press3);
        img_squat_left3 = findViewById(R.id.img_press_left3);
        img_squat_right3 = findViewById(R.id.img_press_right3);
    ...
    private void SquatPodhod2() {
        tv_result_squat2 = findViewById(R.id.tv_result_press2);
        edit_result2 = findViewById(R.id.ed_result_press2);
        btn_squat_add2 = findViewById(R.id.btn_press_add2);
        btn_squat_back2 = findViewById(R.id.btn_press_back2);
        btn_squat_done2 = findViewById(R.id.btn_press_done2);
        layout2 = findViewById(R.id.layout_done_press2);
        img_squat_left2 = findViewById(R.id.img_press_left2);
        img_squat_right2 = findViewById(R.id.img_press_right2);
    ...
    private void SquatPodhod() {
        tv_result_squat = findViewById(R.id.tv_result_press);
        edit_result = findViewById(R.id.ed_result_press);
        btn_squat_add = findViewById(R.id.btn_press_add);
        btn_squat_back = findViewById(R.id.btn_press_back);
        btn_squat_done = findViewById(R.id.btn_press_done);
        layout = findViewById(R.id.layout_done_press);
        img_squat_left = findViewById(R.id.img_press_left);
        img_squat_right = findViewById(R.id.img_press_right);
