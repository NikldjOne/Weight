...
public class Bench_Press extends AppCompatActivity {
    ...
    private DatabaseReference first = databaseReference.child("53");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resultsList = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week1").child("Bench_Press");
        ...
        resultsList_week2 = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week2").child("Bench_Press");
        resultsList_week3 = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week3").child("Bench_Press");
        resultsList_week4 = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week4").child("Bench_Press");
        resultsList_week5 = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week5").child("Bench_Press");
        resultsList_week6 = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week6").child("Bench_Press");
        resultsList_week7 = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week7").child("Bench_Press");
        resultsList_week8 = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week8").child("Bench_Press");
        close_ypr = findViewById(R.id.close_ypr_beanchpr);
        tv_static_beanchpr = findViewById(R.id.tv_static_beanchpr);
        tv_static_beanchpr2 = findViewById(R.id.tv_static_beanchpr2);
        tv_static_beanchpr3 = findViewById(R.id.tv_static_beanchpr3);
        close_ypr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (podhod == true && podhod2 == true && podhod3 == true) {
                                    ...
                                    case 1:
                                        done_week1.child("Week1_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList.child("beanchpr_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if(weight==null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList.child("beanchpr_done").setValue("1");
                                                                finish();
                                                            }
                                    ...
                                    case 2:
                                        done_week2.child("Week2_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList_week2.child("beanchpr_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if(weight==null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week2.child("beanchpr_done").setValue("1");
                                                                finish();
                                                            }
                                    ...
                                    case 3:
                                        done_week3.child("Week3_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList_week3.child("beanchpr_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if(weight==null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week3.child("beanchpr_done").setValue("1");
                                                                finish();
                                                            }
                                    ...
                                    case 4:
                                        done_week4.child("Week4_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList_week4.child("beanchpr_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if(weight==null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week4.child("beanchpr_done").setValue("1");
                                                                finish();
                                                            }
                                    ...
                                    case 5:
                                        done_week5.child("Week5_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList_week5.child("beanchpr_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if(weight==null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week5.child("beanchpr_done").setValue("1");
                                                                finish();
                                                            }
                                    ...
                                    case 6:
                                        done_week6.child("Week6_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList_week6.child("beanchpr_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if(weight==null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week6.child("beanchpr_done").setValue("1");
                                                                finish();
                                                            }
                                    ...
                                    case 7:
                                        done_week7.child("Week7_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList_week7.child("beanchpr_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if(weight==null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week7.child("beanchpr_done").setValue("1");
                                                                finish();
                                                            }
                                    ...
                                    case 8:
                                        done_week8.child("Week8_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList_week8.child("beanchpr_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if(weight==null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week8.child("beanchpr_done").setValue("1");
                                                                finish();
                                                            }
                    ...
                    Toast.makeText(Bench_Press.this, "Вы не закончили все подходы", Toast.LENGTH_SHORT).show();
            }
        });
        resultPodhod();
        squatPodhod();
                                    ...
                                    if (weight != null) {
                                        ...
                                        resultsList.child("beanchpr_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                ...
                                                if (g != null) {
                                                    tv_static_beanchpr.setText(weight_st + " на " + ed_result6);
                                                    tv_static_beanchpr2.setText(weight_st + " на " + ed_result7);
                                                    tv_static_beanchpr3.setText(weight_st + " на " + ed_result8);
    ...
    private void squatPodhod3() {
        tv_result_squat3 = findViewById(R.id.tv_result_beanchpr3);
    ...
    private void squatPodhod2() {
        tv_result_squat2 = findViewById(R.id.tv_result_beanchpr2);
    ...
    private void squatPodhod() {
        tv_result_squat = findViewById(R.id.tv_result_beanchpr);
    ...
    protected void onStart() {
        ...
        weightList.child("max_benchpr").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                String weight = dataSnapshot.getValue(String.class);
