...
public class Dead_Press extends AppCompatActivity {
    private ImageView imageView, img_deadpr_left, img_deadpr_right, img_deadpr_left2, img_deadpr_left3, img_deadpr_left4,
            img_deadpr_left5, img_deadpr_right2, img_deadpr_right3, img_deadpr_right4, img_deadpr_right5, img_deadpr_done;
    private LinearLayout layout, layout2, layout3, layout4, layout5, layout6;
    private TextView tv_weight, tv_result_deadpr, tv_result_deadpr2, tv_result_deadpr3,tv_static_deadpr,tv_static_deadpr2,tv_static_deadpr3;
    private Button btn_deadpr_back, btn_deadpr_back2, btn_deadpr_back3, btn_deadpr_back4, btn_deadpr_back5,
            btn_deadpr_add, btn_deadpr_add2, btn_deadpr_add3, btn_deadpr_add4, btn_deadpr_add5, close_ypr,
            btn_deadpr_done, btn_deadpr_done2, btn_deadpr_done3, btn_deadpr_done4, btn_deadpr_done5;
    ...
    private DatabaseReference first = databaseReference.child("52");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dead_press);
        getSupportActionBar().setDisplayOptions(ActionBar.DISPLAY_SHOW_CUSTOM);
        getSupportActionBar().setCustomView(R.layout.action_bar_layout_17);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        imageView = findViewById(R.id.img_deadpr2);
        tv_weight = findViewById(R.id.tv_weight_deadpr);
        weightList = firebaseDatabase2.getReference("Records").child(user.getUid());
        resultsList = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week1").child("Dead_Press");
        ...
        resultsList_week2 = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week2").child("Dead_Press");
        resultsList_week3 = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week3").child("Dead_Press");
        resultsList_week4 = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week4").child("Dead_Press");
        resultsList_week5 = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week5").child("Dead_Press");
        resultsList_week6 = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week6").child("Dead_Press");
        resultsList_week7 = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week7").child("Dead_Press");
        resultsList_week8 = firebaseDatabase2.getReference("Results").child(user.getUid()).child("Week8").child("Dead_Press");
        close_ypr = findViewById(R.id.close_ypr_deadpr);
        tv_static_deadpr = findViewById(R.id.tv_static_deadpr);
        tv_static_deadpr2 = findViewById(R.id.tv_static_deadpr2);
        tv_static_deadpr3 = findViewById(R.id.tv_static_deadpr3);
        close_ypr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (podhod == true && podhod2 == true && podhod3 == true) {
                                    ...
                                    case 1:
                                        done_week1.child("Week1_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList.child("deadpr_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if (weight == null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList.child("deadpr_done").setValue("1");
                                                                finish();
                                                            }
                                    ...
                                    case 2:
                                        done_week2.child("Week2_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList_week2.child("deadpr_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if (weight == null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week2.child("deadpr_done").setValue("1");
                                                                finish();
                                                            }
                                    ...
                                    case 3:
                                        done_week3.child("Week3_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList_week3.child("deadpr_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if (weight == null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week3.child("deadpr_done").setValue("1");
                                                                finish();
                                                            }
                                    ...
                                    case 4:
                                        done_week4.child("Week4_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList_week4.child("deadpr_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if (weight == null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week4.child("deadpr_done").setValue("1");
                                                                finish();
                                                            }
                                    ...
                                    case 5:
                                        done_week5.child("Week5_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList_week5.child("deadpr_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if (weight == null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week5.child("deadpr_done").setValue("1");
                                                                finish();
                                                            }
                                    ...
                                    case 6:
                                        done_week6.child("Week6_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList_week6.child("deadpr_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if (weight == null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week6.child("deadpr_done").setValue("1");
                                                                finish();
                                                            }
                                    ...
                                    case 7:
                                        done_week7.child("Week7_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList_week7.child("deadpr_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if (weight == null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week7.child("deadpr_done").setValue("1");
                                                                finish();
                                                            }
                                    ...
                                    case 8:
                                        done_week8.child("Week8_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    resultsList_week8.child("deadpr_done").addValueEventListener(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            String weight = dataSnapshot.getValue(String.class);
                                                            if (weight == null) {
                                                            ...
                                                            if (position == 0) {
                                                                ...
                                                                resultsList_week8.child("deadpr_done").setValue("1");
                                                                finish();
                                                            }
                    ...
                    Toast.makeText(Dead_Press.this, "Вы не закончили все подходы", Toast.LENGTH_SHORT).show();
            }
        });
        resultPodhod();
        deadprPodhod();
                                    ...
                                    if (weight != null) {
                                        ...
                                        resultsList.child("deadpr_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                String weight = dataSnapshot.getValue(String.class);
                                                if (weight != null) {
                                                    btn_deadpr_back.setVisibility(View.INVISIBLE);
                                                    btn_deadpr_add.setVisibility(View.INVISIBLE);
                                                    img_deadpr_right.setVisibility(View.INVISIBLE);
                                                    img_deadpr_left.setVisibility(View.INVISIBLE);
                                                    edit_result.setVisibility(View.INVISIBLE);
                                                    tv_result_deadpr.setVisibility(View.VISIBLE);

                                                    btn_deadpr_back2.setVisibility(View.INVISIBLE);
                                                    btn_deadpr_add2.setVisibility(View.INVISIBLE);
                                                    img_deadpr_right2.setVisibility(View.INVISIBLE);
                                                    img_deadpr_left2.setVisibility(View.INVISIBLE);
                                                    edit_result2.setVisibility(View.INVISIBLE);
                                                    tv_result_deadpr2.setVisibility(View.VISIBLE);

                                                    btn_deadpr_back3.setVisibility(View.INVISIBLE);
                                                    btn_deadpr_add3.setVisibility(View.INVISIBLE);
                                                    img_deadpr_right3.setVisibility(View.INVISIBLE);
                                                    img_deadpr_left3.setVisibility(View.INVISIBLE);
                                                    edit_result3.setVisibility(View.INVISIBLE);
                                                    tv_result_deadpr3.setVisibility(View.VISIBLE);
                                                    ...
                                                    tv_result_deadpr.setText(ed_result);
                                                    tv_result_deadpr2.setText(ed_result2);
                                                    tv_result_deadpr3.setText(ed_result3);
                                                    layout6 = findViewById(R.id.layout_done_deadpr6);
                                    ...
                                    if (weight != null) {
                                        ...
                                        resultsList.child("deadpr_done").addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                ...
                                                if (g != null) {
                                                    tv_static_deadpr.setText(weight_st + " на " + ed_result6);
                                                    tv_static_deadpr2.setText(weight_st + " на " + ed_result7);
                                                    tv_static_deadpr3.setText(weight_st + " на " + ed_result8);
    ...
    private void deadprPodhod3() {
        tv_result_deadpr3 = findViewById(R.id.tv_result_deadpr3);
        edit_result3 = findViewById(R.id.ed_result_deadpr3);
        btn_deadpr_add3 = findViewById(R.id.btn_deadpr_add3);
        btn_deadpr_back3 = findViewById(R.id.btn_deadpr_back3);
        btn_deadpr_done3 = findViewById(R.id.btn_deadpr_done3);
        layout3 = findViewById(R.id.layout_done_deadpr3);
        img_deadpr_left3 = findViewById(R.id.img_deadpr_left3);
        img_deadpr_right3 = findViewById(R.id.img_deadpr_right3);


        btn_deadpr_add3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                edAdd3();
            }
        });
        btn_deadpr_back3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                edBack3();
            }
        });
        btn_deadpr_done3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                podhodDone3();
            }
    ...
    private void deadprPodhod2() {
        tv_result_deadpr2 = findViewById(R.id.tv_result_deadpr2);
        edit_result2 = findViewById(R.id.ed_result_deadpr2);
        btn_deadpr_add2 = findViewById(R.id.btn_deadpr_add2);
        btn_deadpr_back2 = findViewById(R.id.btn_deadpr_back2);
        btn_deadpr_done2 = findViewById(R.id.btn_deadpr_done2);
        layout2 = findViewById(R.id.layout_done_deadpr2);
        img_deadpr_left2 = findViewById(R.id.img_deadpr_left2);
        img_deadpr_right2 = findViewById(R.id.img_deadpr_right2);


        btn_deadpr_add2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                edAdd2();
            }
        });
        btn_deadpr_back2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                edBack2();
            }
        });
        btn_deadpr_done2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                podhodDone2();
            }
    ...
    private void deadprPodhod() {
        tv_result_deadpr = findViewById(R.id.tv_result_deadpr);
        edit_result = findViewById(R.id.ed_result_deadpr);
        btn_deadpr_add = findViewById(R.id.btn_deadpr_add);
        btn_deadpr_back = findViewById(R.id.btn_deadpr_back);
        btn_deadpr_done = findViewById(R.id.btn_deadpr_done);
        layout = findViewById(R.id.layout_done_deadpr);
        img_deadpr_left = findViewById(R.id.img_deadpr_left);
        img_deadpr_right = findViewById(R.id.img_deadpr_right);

        btn_deadpr_add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                edAdd();
            }
        });
        btn_deadpr_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                edBack();
            }
        });
        btn_deadpr_done.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                podhodDone();
            }
    ...
    private void podhodDone3() {
        if (podhod3 == false) {
            ...
            podhod3 = false;
            img_deadpr_right3.setVisibility(View.VISIBLE);
            img_deadpr_left3.setVisibility(View.VISIBLE);
            btn_deadpr_back3.setVisibility(View.VISIBLE);
            btn_deadpr_add3.setVisibility(View.VISIBLE);
            edit_result3.setVisibility(View.VISIBLE);
            tv_result_deadpr3.setVisibility(View.INVISIBLE);
    ...
    private void podhodDone2() {
        if (podhod2 == false) {
            ...
            podhod2 = false;
            img_deadpr_right2.setVisibility(View.VISIBLE);
            img_deadpr_left2.setVisibility(View.VISIBLE);
            btn_deadpr_back2.setVisibility(View.VISIBLE);
            btn_deadpr_add2.setVisibility(View.VISIBLE);
            edit_result2.setVisibility(View.VISIBLE);
            tv_result_deadpr2.setVisibility(View.INVISIBLE);
    ...
    private void podhodDone() {
        if (podhod == false) {
            ...
            podhod = false;
            img_deadpr_right.setVisibility(View.VISIBLE);
            img_deadpr_left.setVisibility(View.VISIBLE);
            btn_deadpr_back.setVisibility(View.VISIBLE);
            btn_deadpr_add.setVisibility(View.VISIBLE);
            edit_result.setVisibility(View.VISIBLE);
            tv_result_deadpr.setVisibility(View.INVISIBLE);
    ...
    protected void onStart() {
        ...
        weightList.child("max_deadpr").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                String weight = dataSnapshot.getValue(String.class);
